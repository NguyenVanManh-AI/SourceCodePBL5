    ...
    <div style="display: flex ; flex-direction:column; justify-content: space-between; flex-grow: 1; max-height: calc(100% - 60px); ">
      <div id="my-scroll" style="margin: 6px 14px 0 14px;">
        <ul class="nav-list" style="overflow: visible;">
          ...
          <span>
            <li @click="dashboard">
              <a :class="{adefault:true,aclick:colors[2]}"><i class="fa-solid fa-calendar-check"></i><span class="links_name">Statistical</span></a>
          ...
          <span>
            <li @click="mana_user">
              <a :class="{adefault:true,aclick:colors[8]}"><i class="fa-solid fa-user-large"></i><span class="links_name">User Management</span></a>
          ...
          <span>
            <li @click="mana_admin">
              <a :class="{adefault:true,aclick:colors[9]}"><i class="fa-solid fa-user-shield"></i><span class="links_name">Admin Management</span></a>
          ...
          <span>
            <li @click="changepw">
              <a :class="{adefault:true,aclick:colors[1]}"><i class="fa-solid fa-key"></i><span class="links_name">Change Password</span></a>
  ...
  export default {
    ...
    methods:{
      ...
      helpSupport:function(){
        for(var i=0;i<this.colors.length;i++) this.colors[i] = false;
        this.colors[6]=true;
        this.$router.push({name:'AdminHelpSupport'});
      },
      comments:function(){
        for(var i=0;i<this.colors.length;i++) this.colors[i] = false;
        this.colors[7]=true;
