<template>
  <div id="statistical">
      ...
      <div id="detail_statistical" class="col-12" style="background-color: white;">
          <div style="margin-top: 10px;margin-bottom: 20px;color:gray;text-align: center;font-size: 23px;"><i class="fa-solid fa-calendar-check" style="margin-right: 10px;"></i>Detailed statistics for in <span style="color: green;"><span><span v-if="_currentMonth<10">0</span>{{ _currentMonth }}/{{ currentYear }}</span></span></div>
          <div>
...
export default {
  ...
  mounted(){
      ...
      // Thông tin chi tiết của user đó 
      this.user_statistical = this.user;
