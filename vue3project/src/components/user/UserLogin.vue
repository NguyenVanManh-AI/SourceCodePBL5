        ...
        <div id="big">
          <div class="container col-4">
              <form  @submit.prevent="login()" class="p-3">
                <!-- <div class="col-6 mx-auto"><router-link :to="{ name: 'DashboardMain' }" style="text-decoration: none !important;"><h2 style="font-weight: bold;font-size: 20px;color: #0076e5;" class="text-center"><i class="fa-solid fa-seedling"></i> PBL5</h2></router-link></div> -->
                ...
                <!-- <a class="under" style="text-decoration: none;color: #0085FF;" href="#" data-toggle="modal" data-target="#exampleModalForgotPassword" >Forgot your password ? </a><br> -->
                <!-- <router-link :to="{ name: 'UserRegister' }"><a class="under float-right" style="text-decoration: none;color: #0085FF;" href="#" data-toggle="modal" data-target="#exampleModalForgotPassword" ><i class="fa-solid fa-user-plus"></i> Register ? </a></router-link><br> -->
                <button type="submit" class="mt-4 btn-pers" id="login_button" ><i class="fa-solid fa-paper-plane"></i> Login </button>
              </form>
            </div><br>
          </div>
          <div id="goAdmin" @click="gotoAdmin()">
...
import LoginRequest from '../../restful/user/requests/LoginRequest'
  ...
  export default {
      ...
      mounted(){
        ...
        window.document.title='Login - PBL5';
  ...
  .btn-pers:hover {
    background-color: #0085FF !important;
    box-shadow: 0px 15px 20px #86c1f8;
    color: #fff;
